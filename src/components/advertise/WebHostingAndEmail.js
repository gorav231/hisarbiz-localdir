      ...
      <div className="grid grid-cols-2 gap-8 xl:w-5/6 lg::w-[100%] md:5/6 md:px-7 xxs:w-full xxs:px-2 mx-auto">
        {
           WEB_AND_EMAIL.map((data)=>{
             ...
             return(
              <div className="bg-white rounded-sm lg:col-span-1 md:col-span-2  xxs:col-span-2 md:text-left xxs:text-center" key={id}>
              <button className="absolute 2xl:right-48 xl:right-40 xxs:right-10 -top-2 bg-[#403b53] rounded-sm text-white text-sm px-4 py-1">Enquiry</button>
              ...
              <div className="p-6 flex md:flex-row xxs:flex-col md:justify-between xxs:justify-center">
                  ...
                  <div className="md:w-[70%] xxs:w-[95%] xxs:mx-auto lg:pl-0 md:pl-5 xxs:pl-0">
                      <h1 className="text-xl lg:pl-5 md:pl-0 xxs:pl-0 pb-2 md:pt-0 xxs:pt-10">{heading}</h1>
                      <p className="text-[#676767] font-Mulish leading-6 text-[14px] lg:pl-5 md:pl-0 xxs:pl-0">{para}</p>
