...
const SearchAndSocial = () => {
  return (
    <div className="bg-[#ebeaeb]">
      <div className="grid grid-cols-12 gap-4 2xl:w-5/6 xl:w-[100%] lg:w-[100%] md:5/6 md:px-7 xxs:w-full xxs:px-2 mx-auto md:mt-10 xxs:mt-2 md:mb-16 xxs:mb-20 pt-14 md:pb-14 xxs:pb-5">
        ...
        <div className="xl:col-span-7 lg:col-span-12 md:col-span-12 xxs:col-span-12">
          <h1 className="lg:text-4xl md:text-3xl xxs:text-2xl text-[#282828] pb-8 md:text-left xxs:text-center 2xl:px-10 xl:px-7 lg:px-0 md:px-3 xxs:px-3">Harness Search and Social</h1>
