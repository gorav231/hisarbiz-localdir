  ...
  return (
    <div>
      <div className="grid grid-cols-6 mt-2">
        <div className="col-span-2 bg-[#353535] ">
          <div className="xxs:mx-1 md:pt-10 xxs:pt-2 md:m-2 rounded-md bg-white pt-2 pb-7">
           
            <div className="flex md:flex-row justify-between xxs:flex-row items-center">
              <h1 className="lg:text-3xl md:text-[25px] xxs:text-[15px] leading-7 text-black1-1 font-bold font-roboto xxs:pb-5 md:pb-5 xxs:px-2 xxs:text-left md:text-center">
            ...
            <div className="flex md:flex-row xxs:flex-row items-center justify-center">
              <p className="font-medium ml-1 leading-6 pb-2 font-lato text-lightg-1 text-base xxs:text-center md:text-center md:block xxs:hidden">
            ...
            <div className="bg-white md:p-2 xxs:px-2.5 xxs:py-4 xxs:mx-1.5 rounded-lg xxs:-mt-4 2xl:mx-8 md:mx-0">
