...
const HomeBanner = () => {
  ...
  return (
    <div className="grid grid-cols-6 mt-0 -z-10">
      {/* <div className="col-span-6 "> */}
        <div className="col-span-6 relative -z-10 -top-12 after:content-[''] after:absolute after:h-full after:w-full after:bg-[rgb(0,0,0,0.3)] after:top-0">
        <iframe
